...
> A camada **base de tudo**: como nomear classes CSS em Webflow usando **BEM (Block, Element, Modifier)**. Todos os outros docs assumem essa convenção. Leia este primeiro.
>
> Documento técnico de referência para a equipe — baseado nas diretrizes oficiais do artigo [*Class naming 101: BEM* (Webflow Blog)](https://webflow.com/blog/class-naming-101-bem).
...
Se você vem de Tailwind, a intuição é boa, mas o paradigma é diferente:
...
**Voltar ao índice:** [README](../README.md) | **Próximo:** [01 — Design Tokens →](01-tokens.md)
